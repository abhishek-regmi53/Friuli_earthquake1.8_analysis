...
%%
%Reading strain results from MRHA (Updated Model) approach
mstr=(xlsread("20210623_bending_strain_from_disp_MRHA_3modes_updated.xlsx","total"));
sstr=(xlsread("20210623_shear_strain_from_disp_MRHA_3modes_updated.xlsx","total"));
t1=linspace(0,length(mstr)*0.001,length(mstr));
%%
%Plotting
figure(1)
plot(t,vg1,'r');
...
h1=legend('Strain Gage (VG1)','MRHA (Updated Model)');
h1.FontSize=16;
...
xlabel("Time(sec)",'fontsize',14);
ylabel("Micro-Strain",'fontsize',14);
h1=legend('Strain Gage (RG1)','MRHA (Updated Model)');
h1.FontSize=16;
...
xlabel("Time(sec)",'fontsize',14);
ylabel("Micro-Strain",'fontsize',14);
h1=legend('Strain Gage (VG2)','MRHA (Updated Model)');
h1.FontSize=16;
...
xlabel("Time(sec)",'fontsize',14);
ylabel("Micro-Strain",'fontsize',14);
h1=legend('Strain Gage (RG2)','MRHA (Updated Model)');
h1.FontSize=16;
%%
