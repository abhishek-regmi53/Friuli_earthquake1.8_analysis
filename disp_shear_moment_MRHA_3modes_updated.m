...
a1=xlsread("20210619_accln_MRHA_3modes_updated.xlsx",'mode1');
a2=xlsread("20210619_accln_MRHA_3modes_updated.xlsx",'mode2');
a3=xlsread("20210619_accln_MRHA_3modes_updated.xlsx",'mode3');
...
a=xlsread("20210619_accln_MRHA_3modes_updated.xlsx",'total');



%%
%%
%Modal Properties of 3 modes from updated SAP2000 model
...
xlswrite('20210623_disp_MRHA_3modes_updated.xlsx',u1,'mode1');
...
xlswrite('20210623_disp_MRHA_3modes_updated.xlsx',u2,'mode2');
...
xlswrite('20210623_disp_MRHA_3modes_updated.xlsx',u3,'mode3');
...
%Total displacement
u=u1+u2+u3;
xlswrite('20210623_disp_MRHA_3modes_updated.xlsx',u,'total');
...
xlswrite('20210623_shear_response_from_accln_MRHA_3modes_updated.xlsx',V1,'mode1');
xlswrite('20210623_shear_response_from_disp_MRHA_3modes_updated.xlsx',v1,'mode1');
...
xlswrite('20210623_shear_response_from_accln_MRHA_3modes_updated.xlsx',V2,'mode2');
xlswrite('20210623_shear_response_from_disp_MRHA_3modes_updated.xlsx',v2,'mode2');
%%
...
xlswrite('20210623_shear_response_from_accln_MRHA_3modes_updated.xlsx',V3,'mode3');
xlswrite('20210623_shear_response_from_disp_MRHA_3modes_updated.xlsx',v3,'mode3');
...
%Total Shear Force
V=V1+V2+V3;
xlswrite('20210623_shear_response_from_accln_MRHA_3modes_updated.xlsx',V,'total');
v=v1+v2+v3;
xlswrite('20210623_shear_response_from_disp_MRHA_3modes_updated.xlsx',v,'total');
%%
...
xlswrite('20210623_bending_moment_from_accln_MRHA_3modes_updated.xlsx',M1,'mode1');
xlswrite('20210623_bending_moment_from_disp_MRHA_3modes_updated.xlsx',m1,'mode1');
%%
%Second Mode
i=0;
for t=0:0.001:(length(to)-1)*0.001
...
xlswrite('20210623_bending_moment_from_accln_MRHA_3modes_updated.xlsx',M2,'mode2');
xlswrite('20210623_bending_moment_from_disp_MRHA_3modes_updated.xlsx',m2,'mode2');
%%
%Third Mode
i=0;
for t=0:0.001:(length(to)-1)*0.001
...
xlswrite('20210623_bending_moment_from_accln_MRHA_3modes_updated.xlsx',M3,'mode3');
xlswrite('20210623_bending_moment_from_disp_MRHA_3modes_updated.xlsx',m3,'mode3');
...
M=M1+M2+M3;
m=m1+m2+m3;
xlswrite('20210623_bending_moment_from_accln_MRHA_3modes_updated.xlsx',M,'total');
xlswrite('20210623_bending_moment_from_disp_MRHA_3modes_updated.xlsx',m,'total');
%%
...
Mstr3=(M3*y*1e6)/(E*I);
Mstr=(M*y*1e6)/(E*I);
xlswrite('20210623_bending_strain_from_accln_MRHA_3modes_updated.xlsx',Mstr1,'mode1');
xlswrite('20210623_bending_strain_from_accln_MRHA_3modes_updated.xlsx',Mstr2,'mode2');
xlswrite('20210623_bending_strain_from_accln_MRHA_3modes_updated.xlsx',Mstr3,'mode3');
xlswrite('20210623_bending_strain_from_accln_MRHA_3modes_updated.xlsx',Mstr,'total');
...
mstr3=(m3*y*1e6)/(E*I);
mstr=(m*y*1e6)/(E*I);
xlswrite('20210623_bending_strain_from_disp_MRHA_3modes_updated.xlsx',mstr1,'mode1');
xlswrite('20210623_bending_strain_from_disp_MRHA_3modes_updated.xlsx',mstr2,'mode2');
xlswrite('20210623_bending_strain_from_disp_MRHA_3modes_updated.xlsx',mstr3,'mode3');
xlswrite('20210623_bending_strain_from_disp_MRHA_3modes_updated.xlsx',mstr,'total');
...
Sstr=(V/(2*b*t*G))*1e6;
xlswrite('20210623_Shear_strain_from_accln_MRHA_3modes_updated.xlsx',Sstr1,'mode1');
xlswrite('20210623_Shear_strain_from_accln_MRHA_3modes_updated.xlsx',Sstr2,'mode2');
xlswrite('20210623_Shear_strain_from_accln_MRHA_3modes_updated.xlsx',Sstr3,'mode3');
xlswrite('20210623_Shear_strain_from_accln_MRHA_3modes_updated.xlsx',Sstr,'total');
...
sstr3=(v3/(2*b*t*G))*1e6;
sstr=(v/(2*b*t*G))*1e6;
xlswrite('20210623_shear_strain_from_disp_MRHA_3modes_updated.xlsx',sstr1,'mode1');
xlswrite('20210623_shear_strain_from_disp_MRHA_3modes_updated.xlsx',sstr2,'mode2');
xlswrite('20210623_shear_strain_from_disp_MRHA_3modes_updated.xlsx',sstr3,'mode3');
xlswrite('20210623_shear_strain_from_disp_MRHA_3modes_updated.xlsx',sstr,'total');
