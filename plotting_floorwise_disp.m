...
% acc_MRHA1=xlsread("20210623_disp_MRHA_3modes_updated.xlsx","mode1");
% acc_MRHA2=xlsread("20210623_disp_MRHA_3modes_updated.xlsx","mode2");
% acc_MRHA3=xlsread("20210623_disp_MRHA_3modes_updated.xlsx","mode3");
% acc_MRHA=xlsread("20210623_disp_MRHA_3modes_updated.xlsx","total");
% to=linspace(0,length(acc_MRHA)*0.001,length(acc_MRHA));
% 
% %%
% %Displacement from Orthogonal Filter
% acc_Mdlim1=xlsread("20210617_disp_orthogonal_filter.xlsx","mode1");
% acc_Mdlim2=xlsread("20210617_disp_orthogonal_filter.xlsx","mode2");
% acc_Mdlim3=xlsread("20210617_disp_orthogonal_filter.xlsx","mode3");
% acc_Mdlim=xlsread("20210617_disp_orthogonal_filter.xlsx","total");
...
% title("Comparison of Mode wise floor Displacement, Mode1","fontsize",18);
...
% h=[p1;p2];
% h1=legend(h,'MRHA','Orthogonal Filter');
% title("Comparison of Mode wise floor Displacement, Mode2","fontsize",18);
% xlabel("Displacement","fontsize",16);
% ylabel("Floor","fontsize",16);
% h1.FontSize=16;
% ax=gca;
...
% h=[p1;p2];
% h1=legend(h,'MRHA','Orthogonal Filter');
% title("Comparison of Mode wise floor Displacement, Mode3","fontsize",18);
% xlabel("Displacement","fontsize",16);
% ylabel("Floor","fontsize",16);
% h1.FontSize=16;
% ax=gca;
...
% h=[p1;p2];
% h1=legend(h,'MRHA','Orthogonal Filter');
% title("Comparison of Mode wise floor Displacement, Total","fontsize",18);
% xlabel("Displacement","fontsize",16);
% ylabel("Floor","fontsize",16);
% h1.FontSize=16;
% ax=gca;
...
%%
%Displacement from MRHA
acc_MRHA1=xlsread("20210623_disp_MRHA_3modes.xlsx","mode1");
acc_MRHA2=xlsread("20210623_disp_MRHA_3modes.xlsx","mode2");
acc_MRHA3=xlsread("20210623_disp_MRHA_3modes.xlsx","mode3");
acc_MRHA=xlsread("20210623_disp_MRHA_3modes.xlsx","total");
to=linspace(0,length(acc_MRHA)*0.001,length(acc_MRHA));
