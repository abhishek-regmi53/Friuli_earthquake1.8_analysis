...
%%
%Reading strain results from 3modes_updated approach
...
to=linspace(0,length(mstr)*0.001,length(mstr));
%%
%Plotting
figure(1)
plot(t,vg1,'r');
...
h1=legend('Strain Gage (VG1)','MRHA');
h1.FontSize=16;
...
xlabel("Time(sec)",'fontsize',14);
ylabel("Micro-Strain",'fontsize',14);
h1=legend('Strain Gage (RG1)','MRHA');
h1.FontSize=16;
...
xlabel("Time(sec)",'fontsize',14);
ylabel("Micro-Strain",'fontsize',14);
h1=legend('Strain Gage (VG2)','MRHA');
h1.FontSize=16;
...
xlabel("Time(sec)",'fontsize',14);
ylabel("Micro-Strain",'fontsize',14);
h1=legend('Strain Gage (RG2)','MRHA');
h1.FontSize=16;
%%
