...
%%
%IMPORTANT: Modal Properties taken from Updated Model
...
csvwrite('20210619_modal_accln_MRHA_3modes_updated.csv',qa);
csvwrite('20210619_modal_coordinate_MRHA_3modes_updated.csv',q);