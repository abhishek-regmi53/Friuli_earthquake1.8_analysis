...
xlswrite('20210619_accln_MRHA_3modes.xlsx',a1,'mode1');
...
xlswrite('20210619_accln_MRHA_3modes.xlsx',a2,'mode2');
...
xlswrite('20210619_accln_MRHA_3modes.xlsx',a3,'mode3');
...
a=a1+a2+a3;
xlswrite('20210619_accln_MRHA_3modes.xlsx',a,'total');
