%Comparison of Floor acceleration%

%%
%Acceleration from MRHA
% acc_MRHA1=xlsread("20210619_accln_MRHA_3modes.xlsx","mode1");
% acc_MRHA2=xlsread("20210619_accln_MRHA_3modes.xlsx","mode2");
% acc_MRHA3=xlsread("20210619_accln_MRHA_3modes.xlsx","mode3");
% acc_MRHA=xlsread("20210619_accln_MRHA_3modes.xlsx","total");
% to=linspace(0,length(acc_MRHA)*0.001,length(acc_MRHA));
% 
% %%
% %Acceleration from Orthogonal Filter
% acc_Mdlim1=xlsread("20210617_accln_orthogonal_filter.xlsx","mode1");
% acc_Mdlim2=xlsread("20210617_accln_orthogonal_filter.xlsx","mode2");
% acc_Mdlim3=xlsread("20210617_accln_orthogonal_filter.xlsx","mode3");
% acc_Mdlim=xlsread("20210617_accln_orthogonal_filter.xlsx","total");
...
% title("Comparison of Mode wise floor Acceleration, Mode1","fontsize",20);
% xlabel("Acceleration","fontsize",20);
% ylabel("Floor","fontsize",20);
% h1.FontSize=20;
% ax=gca;
...
% h=[p1;p2];
% h1=legend(h,'MRHA','Orthogonal Filter');
% title("Comparison of Mode wise floor Acceleration, Mode2","fontsize",20);
% % xlabel("Acceleration","fontsize",16);
...
% h=[p1;p2];
% h1=legend(h,'MRHA','Orthogonal Filter');
% title("Comparison of Mode wise floor Acceleration, Mode3","fontsize",20);
% % xlabel("Acceleration","fontsize",16);
% % ylabel("Floor","fontsize",16);
% % h1.FontSize=16;
% % ax=gca;
...
% h=[p1;p2];
% h1=legend(h,'MRHA','Orthogonal Filter');
% title("Comparison of Mode wise floor Acceleration, Total","fontsize",20);
% % xlabel("Acceleration","fontsize",16);
% % ylabel("Floor","fontsize",16);
% % h1.FontSize=16;
% % ax=gca;
...
xlabel("Acceleration(m/s/s)","fontsize",16);
ylabel("Floor","fontsize",16);
h1.FontSize=16;
ax=gca;
ax.XAxisLocation='origin';
